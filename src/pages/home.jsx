    ...
    <section className='home' id='home'>
        <div className="home__container container grid">
            <div className="home__content">
                {homes.map((item) => (
                    <><span className="home__small">{item.small_text}</span><h1 className="home__title"> <span>i'm</span> adedoyinsola <br /> a <span>software engineer</span></h1><p className="home__description">
                        {item.description}
                    </p></> 
                ))}   
